	...
	while (exitListing != true) {
		...
		for (int x = (page*10)-10; x < book[0]->getBookCount(); x++) {
			...
			if (skip != true) {
				...
				cout << left << setw(50) << aTitle << " " << setw(10) << book[x]->getIsbn() << " " << setw(20) << aAuthor << " " << setw(20) << aPublisher << " " << setw(20) << book[x]->getDateAdded() << " " << right << setw(5) << book[x]->getQtyOnHand() << " " << "$" << setw(10) << book[x]->getWholesale() << " " << "$" << setw(10) << book[x]->getRetail() << "\n" << endl;
	...
	while (exitWholesale != true) {
		...
		for (int x = (page*10)-10; x < book[0]->getBookCount(); x++) {
			...
			if (skip != true) {
				...
				string aAuthor = book[x]->getAuthor().substr(0,19);
				string aPublisher = book[x]->getPublisher().substr(0,19);
				cout << left << setw(50) << aTitle << " " << setw(10) << book[x]->getIsbn() << " " << right << setw(5) << book[x]->getQtyOnHand() << " " << setw(10) << "$" << book[x]->getWholesale() << "\n" << endl;
	...
	while (exitRetail != true) {
		...
		for (int x = (page*10)-10; x < book[0]->getBookCount(); x++) {
			...
			if (skip != true) {
				...
				string aAuthor = book[x]->getAuthor().substr(0,19);
				string aPublisher = book[x]->getPublisher().substr(0,19);
				cout << left << setw(50) << aTitle << " " << setw(10) << book[x]->getIsbn() << " " << right << setw(5) << book[x]->getQtyOnHand() << " " << setw(10) << "$" << book[x]->getRetail() << "\n" << endl;
